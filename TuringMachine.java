...
public class TuringMachine {
	...
	private int currentSymbol;
        /**
         * Crée une classe dans une autre classe
         */
	class Transition {
		String readState;
		char readSymbol;
	...
	public boolean setStartState(String newStartState) {
        ...
        /**
         * Set le nouvel état acepté
         * @param newAcceptState String
         * @return boolean
         */
	public boolean setAcceptState(String newAcceptState) {
        ...
        /**
         * Set le nouvel état refusé
         * @param newRejectState string
         * @return boolean
         */
	public boolean setRejectState(String newRejectState) {
        ...
        /**
         * Ajout d'une transition suplémentaire
         * @param rState string
         * @param rSymbol char
         * @param wState String
         * @param wSymbol char
         * @param mDirection boolean
         * @return boolean 
         */
